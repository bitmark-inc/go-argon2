...
// function.
int argon2_wrapper(uint8_t *out, uint32_t outlen, uint8_t *pwd, uint32_t pwdlen,
                   uint8_t *salt, uint32_t saltlen, uint8_t *secret,
                   uint32_t secretlen, uint8_t *ad, uint32_t adlen,
                   ...
                   allocate_fptr allocate_cbk, deallocate_fptr free_cbk,

                   uint32_t flags, argon2_type type) {

  argon2_context context = {.out = out,
                            .outlen = outlen,
